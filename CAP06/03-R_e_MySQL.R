...
?dbConnect
con = dbConnect(MySQL(), user = "root", password = "chuva444", dbname = "titanicDB", host = "localhost")
...
?src_mysql
con2 <- src_mysql(dbname = "titanicdb", user = "root", password = "chuva444", host = "localhost")
