...
setwd("C:/Users/conta/OneDrive/Documentos/DataScience/BIG_DATA_R_AZURE/Cap05")
getwd()
...
list.files()
lista_arquivos <- list.files('C:/Users/conta/OneDrive/Documentos/DataScience/BIG_DATA_R_AZURE/Cap05/arquivos', full.names = TRUE)
